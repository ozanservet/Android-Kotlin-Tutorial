...
// With Serializable helps us to pass them to one class to another.
// However, Parcelable is another method that is 5 times faster.
// You can use Serializable as well. However, Parcelable is a faster than Serializable.